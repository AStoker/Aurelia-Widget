function _aureliaConfigureModuleLoader() {
    etrieveReq = requirejs.config({
        ...
        "paths": {
            ...
            "aurelia-web-components": "../node_modules/aurelia-web-components/dist/amd/aurelia-web-components",
            "app-bundle": "../widget/app-bundle",
            "aurelia-bundle": "../widget/aurelia-bundle"
        },
        "packages": [{
