var __etrieve;(function () { if (!__etrieve || !__etrieve.requirejs) {
if (!__etrieve) { __etrieve = {}; } else { require = __etrieve; }
...
(function (global, setTimeout) {
    ...
    /**
     * Support __etrieve.require.config() to make it easier to cooperate with other
...
__etrieve.requirejs = requirejs;__etrieve.require = require;__etrieve.define = define;
}
}());
...
*/
var l,aa="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;function m(){this.end=this.start=0;this.rules=this.parent=this.previous=null;this.cssText=this.parsedCssText="";this.atRule=!1;this.type=0;this.parsedSelector=this.selector=this.keyframesName=""}
...
__etrieve.define("@webcomponents/shadycss/scoping-shim.min", [],function(){});

;__etrieve.define('@webcomponents/shadycss', ['@webcomponents/shadycss/scoping-shim.min'], function (main) { return main; });
...
__etrieve.define('resources/elements/style-inject/style-inject',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
    ...
    var StyleInject = exports.StyleInject = (_dec = (0, _aureliaFramework.containerless)(), _dec2 = (0, _aureliaFramework.inlineView)('<template><style ref="styleTag"></style></template>'), _dec3 = (0, _aureliaFramework.inject)(Element, _aureliaFramework.Loader), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
        function StyleInject(element, loader) {
            ...
            _initDefineProp(this, 'isolate', _descriptor2, this);
        ...
        StyleInject.prototype.isolateChanged = function isolateChanged(isolate) {
            switch (isolate) {
                case undefined:
                case null:
                case false:
        ...
        enumerable: true,
        initializer: null
    }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, 'isolate', [_aureliaFramework.bindable], {
        enumerable: true,
        initializer: null
...
__etrieve.define('text!resources/elements/document-viewer/document-viewer.css', ['module'], function(module) { module.exports = ":host h1 {\n  color: red; }\n"; });
__etrieve.define('main',['exports', 'aurelia-web-components', './environment'], function (exports, _aureliaWebComponents, _environment) {
    ...
    function configure(aurelia) {
        aurelia.use.standardConfiguration().globalResources('resources/elements/document-viewer/document-viewer');
        ...
        aurelia.start().then(function () {
            var registry = aurelia.container.get(_aureliaWebComponents.ComponentRegistry);

            registry.registerAllGlobalElements();
        });
    }
});
__etrieve.define('environment',["exports"], function (exports) {
  "use strict";
...
__etrieve.define('EtrieveLoader',['exports', 'aurelia-metadata', 'aurelia-loader-default', 'aurelia-pal'], function (exports, _aureliaMetadata, _aureliaLoaderDefault, _aureliaPal) {
  ...
  exports.EtrieveLoader = undefined;
  ...
  var EtrieveLoader = exports.EtrieveLoader = function (_DefaultLoader) {
    _inherits(EtrieveLoader, _DefaultLoader);

    function EtrieveLoader() {
      _classCallCheck(this, EtrieveLoader);

      return _possibleConstructorReturn(this, _DefaultLoader.call(this));
    }

    return EtrieveLoader;
  }(_aureliaLoaderDefault.DefaultLoader);
    ...
    if (!_aureliaPal.PLATFORM.global.System || !_aureliaPal.PLATFORM.global.System.import) {
      ...
      EtrieveLoader.prototype._import = function (moduleId) {
        return new Promise(function (resolve, reject) {
          _aureliaPal.PLATFORM.global.__etrieve.require([moduleId], resolve, reject);
        });
      };
      ...
      EtrieveLoader.prototype.loadModule = function (id) {
        ...
        return new Promise(function (resolve, reject) {
          _aureliaPal.PLATFORM.global.__etrieve.require([id], function (m) {
      ...
      EtrieveLoader.prototype.addPlugin = function (pluginName, implementation) {
        var nonAnonDefine = __etrieve.define;
...
__etrieve.define('aurelia-web-components',['exports', 'aurelia-dependency-injection', 'aurelia-pal', 'aurelia-templating'], function (exports, _aureliaDependencyInjection, _aureliaPal, _aureliaTemplating) {
  'use strict';
...
__etrieve.define('aurelia-testing/wait',["require", "exports"], function (require, exports) {
    "use strict";
...
__etrieve.define('aurelia-testing/view-spy',["require", "exports", "aurelia-templating", "aurelia-logging"], function (require, exports, aurelia_templating_1, aurelia_logging_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
__etrieve.define('aurelia-testing/component-tester',["require", "exports", "aurelia-templating", "./wait"], function (require, exports, aurelia_templating_1, wait_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
__etrieve.define('aurelia-testing/compile-spy',["require", "exports", "aurelia-templating", "aurelia-dependency-injection", "aurelia-logging", "aurelia-pal"], function (require, exports, aurelia_templating_1, aurelia_dependency_injection_1, aurelia_logging_1, aurelia_pal_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
__etrieve.define('aurelia-testing/aurelia-testing',["require", "exports", "./compile-spy", "./view-spy", "./component-tester", "./wait"], function (require, exports, compile_spy_1, view_spy_1, component_tester_1, wait_1) {
    "use strict";
    function __export(m) {
...
;__etrieve.define('aurelia-testing', ['aurelia-testing/aurelia-testing'], function (main) { return main; });

__etrieve.define('aurelia-templating',['exports', 'aurelia-logging', 'aurelia-metadata', 'aurelia-pal', 'aurelia-loader', 'aurelia-path', 'aurelia-dependency-injection', 'aurelia-binding', 'aurelia-task-queue'], function (exports, _aureliaLogging, _aureliaMetadata, _aureliaPal, _aureliaLoader, _aureliaPath, _aureliaDependencyInjection, _aureliaBinding, _aureliaTaskQueue) {
  'use strict';
...
__etrieve.define('aurelia-templating-router/router-view',['exports', 'aurelia-dependency-injection', 'aurelia-binding', 'aurelia-templating', 'aurelia-router', 'aurelia-metadata', 'aurelia-pal'], function (exports, _aureliaDependencyInjection, _aureliaBinding, _aureliaTemplating, _aureliaRouter, _aureliaMetadata, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-templating-router/route-loader',['exports', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-router', 'aurelia-path', 'aurelia-metadata', './router-view'], function (exports, _aureliaDependencyInjection, _aureliaTemplating, _aureliaRouter, _aureliaPath, _aureliaMetadata, _routerView) {
  'use strict';
...
__etrieve.define('aurelia-templating-router/route-href',['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-router', 'aurelia-pal', 'aurelia-logging'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaRouter, _aureliaPal, _aureliaLogging) {
  'use strict';
...
__etrieve.define('aurelia-templating-router/aurelia-templating-router',['exports', 'aurelia-router', './route-loader', './router-view', './route-href'], function (exports, _aureliaRouter, _routeLoader, _routerView, _routeHref) {
  'use strict';
...
;__etrieve.define('aurelia-templating-router', ['aurelia-templating-router/aurelia-templating-router'], function (main) { return main; });

__etrieve.define('aurelia-templating-resources/with',['exports', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-binding'], function (exports, _aureliaDependencyInjection, _aureliaTemplating, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/update-trigger-binding-behavior',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/throttle-binding-behavior',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/signal-binding-behavior',['exports', 'aurelia-binding', './binding-signaler'], function (exports, _aureliaBinding, _bindingSignaler) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/show',['exports', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-pal', './aurelia-hide-style'], function (exports, _aureliaDependencyInjection, _aureliaTemplating, _aureliaPal, _aureliaHideStyle) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/set-repeat-strategy',['exports', './repeat-utilities'], function (exports, _repeatUtilities) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/self-binding-behavior',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/sanitize-html',['exports', 'aurelia-binding', 'aurelia-dependency-injection', './html-sanitizer'], function (exports, _aureliaBinding, _aureliaDependencyInjection, _htmlSanitizer) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/replaceable',['exports', 'aurelia-dependency-injection', 'aurelia-templating'], function (exports, _aureliaDependencyInjection, _aureliaTemplating) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/repeat',['exports', 'aurelia-dependency-injection', 'aurelia-binding', 'aurelia-templating', './repeat-strategy-locator', './repeat-utilities', './analyze-view-factory', './abstract-repeater'], function (exports, _aureliaDependencyInjection, _aureliaBinding, _aureliaTemplating, _repeatStrategyLocator, _repeatUtilities, _analyzeViewFactory, _abstractRepeater) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/repeat-utilities',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/repeat-strategy-locator',['exports', './null-repeat-strategy', './array-repeat-strategy', './map-repeat-strategy', './set-repeat-strategy', './number-repeat-strategy'], function (exports, _nullRepeatStrategy, _arrayRepeatStrategy, _mapRepeatStrategy, _setRepeatStrategy, _numberRepeatStrategy) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/number-repeat-strategy',['exports', './repeat-utilities'], function (exports, _repeatUtilities) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/null-repeat-strategy',["exports"], function (exports) {
  "use strict";
...
__etrieve.define('aurelia-templating-resources/map-repeat-strategy',['exports', './repeat-utilities'], function (exports, _repeatUtilities) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/if',['exports', 'aurelia-templating', 'aurelia-dependency-injection', './if-core'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _ifCore) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/if-core',["exports"], function (exports) {
  "use strict";
...
__etrieve.define('aurelia-templating-resources/html-sanitizer',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/html-resource-plugin',['exports', 'aurelia-templating', './dynamic-element'], function (exports, _aureliaTemplating, _dynamicElement) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/hide',['exports', 'aurelia-dependency-injection', 'aurelia-templating', 'aurelia-pal', './aurelia-hide-style'], function (exports, _aureliaDependencyInjection, _aureliaTemplating, _aureliaPal, _aureliaHideStyle) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/focus',['exports', 'aurelia-templating', 'aurelia-binding', 'aurelia-task-queue', 'aurelia-pal'], function (exports, _aureliaTemplating, _aureliaBinding, _aureliaTaskQueue, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/else',['exports', 'aurelia-templating', 'aurelia-dependency-injection', './if-core'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _ifCore) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/dynamic-element',['exports', 'aurelia-templating'], function (exports, _aureliaTemplating) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/debounce-binding-behavior',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/css-resource',['exports', 'aurelia-templating', 'aurelia-loader', 'aurelia-dependency-injection', 'aurelia-path', 'aurelia-pal'], function (exports, _aureliaTemplating, _aureliaLoader, _aureliaDependencyInjection, _aureliaPath, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/compose',['exports', 'aurelia-dependency-injection', 'aurelia-task-queue', 'aurelia-templating', 'aurelia-pal'], function (exports, _aureliaDependencyInjection, _aureliaTaskQueue, _aureliaTemplating, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/binding-signaler',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/binding-mode-behaviors',['exports', 'aurelia-binding', 'aurelia-metadata'], function (exports, _aureliaBinding, _aureliaMetadata) {
  'use strict';
...
;__etrieve.define('aurelia-templating-resources', ['aurelia-templating-resources/aurelia-templating-resources'], function (main) { return main; });

__etrieve.define('aurelia-templating-resources/aurelia-hide-style',['exports', 'aurelia-pal'], function (exports, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/attr-binding-behavior',['exports', 'aurelia-binding'], function (exports, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/array-repeat-strategy',['exports', './repeat-utilities', 'aurelia-binding'], function (exports, _repeatUtilities, _aureliaBinding) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/analyze-view-factory',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-templating-resources/abstract-repeater',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-templating-binding',['exports', 'aurelia-logging', 'aurelia-binding', 'aurelia-templating'], function (exports, _aureliaLogging, _aureliaBinding, _aureliaTemplating) {
  'use strict';
...
__etrieve.define('aurelia-task-queue',['exports', 'aurelia-pal'], function (exports, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-router',['exports', 'aurelia-logging', 'aurelia-route-recognizer', 'aurelia-dependency-injection', 'aurelia-history', 'aurelia-event-aggregator'], function (exports, _aureliaLogging, _aureliaRouteRecognizer, _aureliaDependencyInjection, _aureliaHistory, _aureliaEventAggregator) {
  'use strict';
...
__etrieve.define('aurelia-route-recognizer',['exports', 'aurelia-path'], function (exports, _aureliaPath) {
  'use strict';
...
__etrieve.define('aurelia-polyfills',['aurelia-pal'], function (_aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-path',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-pal',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-pal-browser',['exports', 'aurelia-pal'], function (exports, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-metadata',['exports', 'aurelia-pal'], function (exports, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-logging',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-logging-console',['exports', 'aurelia-logging'], function (exports, _aureliaLogging) {
  'use strict';
...
__etrieve.define('aurelia-loader',['exports', 'aurelia-path', 'aurelia-metadata'], function (exports, _aureliaPath, _aureliaMetadata) {
  'use strict';
...
__etrieve.define('aurelia-loader-default',['exports', 'aurelia-loader', 'aurelia-pal', 'aurelia-metadata'], function (exports, _aureliaLoader, _aureliaPal, _aureliaMetadata) {
  'use strict';
...
__etrieve.define('aurelia-history',['exports'], function (exports) {
  'use strict';
...
__etrieve.define('aurelia-history-browser',['exports', 'aurelia-pal', 'aurelia-history'], function (exports, _aureliaPal, _aureliaHistory) {
  'use strict';
...
__etrieve.define('aurelia-event-aggregator',['exports', 'aurelia-logging'], function (exports, _aureliaLogging) {
  'use strict';
...
__etrieve.define('aurelia-dependency-injection',['exports', 'aurelia-metadata', 'aurelia-pal'], function (exports, _aureliaMetadata, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-bootstrapper',['module', 'exports', 'aurelia-pal', 'aurelia-polyfills'], function (module, exports, _aureliaPal) {
  'use strict';
...
__etrieve.define('aurelia-binding',['exports', 'aurelia-logging', 'aurelia-pal', 'aurelia-task-queue', 'aurelia-metadata'], function (exports, _aureliaLogging, _aureliaPal, _aureliaTaskQueue, _aureliaMetadata) {
  'use strict';
...
__etrieve.define('widget/initializer.js',["aurelia-bootstrapper", "aurelia-pal", "EtrieveLoader", "main"], function(bootstrapper, aureliaPal, loader, main){
